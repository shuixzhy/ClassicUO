...
namespace ClassicUO.Game.UI.Controls
{
    internal class MacroControl : Control
    {
        ...
        public MacroControl(string name)
        {
            ...
            _checkbox.X = 0;
            _checkbox.Y = box.Height +30;
            _checkbox.ValueChanged += Ischecked;
            Add(_checkbox);
            _delaybar = new HSliderBar(50, box.Height+55, 150, 100,5000, _collection.Macro.Delay, HSliderBarStyle.MetalWidgetRecessedBar, true, 0xff, 999);
