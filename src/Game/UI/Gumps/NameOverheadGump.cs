    ...
    internal class NameOverheadGump : Gump
    {
        ...
        protected override void OnMouseOver(int x, int y)
        {
            ...
            if (Entity is Mobile m)
            {
                ...
                _lockedPosition.Y = (int) ((Entity.RealScreenPosition.Y + (m.Offset.Y - m.Offset.Z) - (height + centerY + 18) + (!m.IsMounted ? 22 : 0)) / scale);
            }
        ...
        public override bool Draw(UltimaBatcher2D batcher, int x, int y)
        {
            ...
            if (Entity is Mobile m)
            {
                ...
                else
                {
                    ...
                    y = (int) ((Entity.RealScreenPosition.Y + (m.Offset.Y - m.Offset.Z) - (height + centerY + 18) + (!m.IsMounted ? 22 : 0)) / scale);
                }
            }
