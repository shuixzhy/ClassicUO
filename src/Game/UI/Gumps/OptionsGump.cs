...
namespace ClassicUO.Game.UI.Gumps
{
    internal class OptionsGump : Gump
    {
        ...
        //experimental
        private Checkbox _enableSelectionArea, _debugGumpIsDisabled, _restoreLastGameSize, _disableTabBtn, _disableCtrlQWBtn, _disableDefaultHotkeys, _disableArrowBtn, _overrideContainerLocation,  _showTargetRangeIndicator;
        ...
        public void BuildAutoPilot()
        {
            ...
            _corpseScale = new HSliderBar(text.X + text.Width + 10, text.Y, 150, 1, 3, Engine.Profile.Current.CorpseScale, HSliderBarStyle.MetalWidgetRecessedBar, true, 0xff, 999);
            fpsItem.Add(text);
            ...
            _itemScale = new HSliderBar(text.X + text.Width + 10, text.Y, 150, 3, 6, Engine.Profile.Current.ItemScale, HSliderBarStyle.MetalWidgetRecessedBar, true, 0xff, 999);
