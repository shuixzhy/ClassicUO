...
namespace ClassicUO.Game.UI.Gumps.Login
{
    internal class LoginGump : Gump
    {
        ...
        public LoginGump() : base(0, 0)
        {
            ...
            Add(new Label($"UO ClientVersion {Engine.GlobalSettings.ClientVersion}.", false, 0x00D3, font: 9)
            {
                X = 286,
                Y = 453
            });

            Add(new Label($"ClassicUO ClientVersion {Engine.Version}", false, 0x00D3, font: 9)
            {
                X = 286,
                Y = 465
            });
