...
namespace ClassicUO.Game.UI.Gumps
{
    internal class TopBarGump : Gump
    {
        private TopBarGump() : base(0, 0)
        {
            ...
            string[] texts = {LanguageManager.Current.UI_TopBar_Map, LanguageManager.Current.UI_TopBar_Paperdoll, LanguageManager.Current.UI_TopBar_Inventory, LanguageManager.Current.UI_TopBar_Journal, LanguageManager.Current.UI_TopBar_Chat, LanguageManager.Current.UI_TopBar_Help, LanguageManager.Current.UI_TopBar_WorldMap, LanguageManager.Current.UI_TargetMenu,"< ? >", LanguageManager.Current.UI_TopBar_Debug,LanguageManager.Current.UI_TopBar_UOStore, LanguageManager.Current.UI_TopBar_GlobalChat };
