...
namespace ClassicUO.Game.UI.Gumps
{
    internal class PaperDollGump : TextContainerGump
    {
        ...
        private void BuildGump()
        {
            ...
            Add(new EquipmentSlot(2, 75 + 21 * 6, Mobile, Layer.Talisman, this));

            Add(new EquipmentSlot(170, 75 , Mobile, Layer.Robe, this));
            Add(new EquipmentSlot(170, 75 + 21 , Mobile, Layer.Torso, this));
            Add(new EquipmentSlot(170, 75 + 21 * 2, Mobile, Layer.Pants, this));
            Add(new EquipmentSlot(170, 75 + 21 * 3, Mobile, Layer.Gloves, this));
            Add(new EquipmentSlot(170, 75 + 21 * 4, Mobile, Layer.Arms, this));
            Add(new EquipmentSlot(170, 75 + 21 * 5, Mobile, Layer.Skirt, this));
            Add(new EquipmentSlot(170, 75 + 21 * 6, Mobile, Layer.Waist, this));

            Add(new EquipmentSlot(62, 240, Mobile, Layer.Shirt, this));
            Add(new EquipmentSlot(62 + 21, 240, Mobile, Layer.Shoes, this));
            Add(new EquipmentSlot(62 + 42, 240, Mobile, Layer.Legs, this));
            Add(new EquipmentSlot(62 + 63, 240, Mobile, Layer.Cloak, this));

            Add(new EquipmentSlot(2, 240, Mobile, Layer.OneHanded, this));
            Add(new EquipmentSlot(170, 240, Mobile, Layer.TwoHanded, this));
            // Paperdoll control!
