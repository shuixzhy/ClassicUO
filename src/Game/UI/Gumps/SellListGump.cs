...
namespace ClassicUO.Game.UI.Gumps
{
    internal class SellListGump : Gump
    {
        ...
        public SellListGump() : base(0,0)
        {
            ...
            NiceButton setSellBag = new NiceButton(3, Height - 23, 50 * Engine.Profile.Current.CorpseScale, 10 * Engine.Profile.Current.CorpseScale, ButtonAction.Activate, Language.Language.UI_Add) { ButtonParameter = 2, IsSelectable = false };
            Add(setSellBag);
        ...
        public override void OnButtonClick(int buttonID)
        {
            ...
            else if (buttonID == 2)
            {
                ...
                TargetManager.SetTargeting(CursorTarget.AddToSelllist, Serial.INVALID, TargetType.Neutral);
            }
            else
        ...
        public void RedrawItems()
        {
            ...
            {
                SellListItem lootitem = new SellListItem(item, size);
        ...
        private class SellListItem : Control
        {
            ...
            public SellListItem(ushort[] item, int size)
            {
                ...
                _texture.MouseUp += (sender, e) =>
                {
                    ...
                    {
                        Engine.Profile.Current.SellList.Remove(item);
                        Dispose();
                    }
                };
