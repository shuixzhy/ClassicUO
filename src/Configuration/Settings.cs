...
namespace ClassicUO.Configuration
{
    internal sealed class Settings
    {
        ...
        [JsonProperty(PropertyName = "ip（地址）")] public string IP { get; set; } = "127.0.0.1";

        [JsonProperty(PropertyName = "port（端口）")] public ushort Port { get; set; } = 2593;

        [JsonProperty(PropertyName = "ultimaonlinedirectory（UO目录）")]
        public string UltimaOnlineDirectory { get; set; } = "";

        [JsonProperty(PropertyName = "clientversion（客户端版本）")]
        public string ClientVersion { get; set; } = string.Empty;

        [JsonProperty(PropertyName = "lastcharactername")]
        public string LastCharacterName { get; set; } = string.Empty;

        [JsonProperty(PropertyName = "cliloc（语言文件）")]
        ...
        [JsonProperty(PropertyName = "plugins（插件）")]
