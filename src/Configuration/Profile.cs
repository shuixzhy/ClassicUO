...
namespace ClassicUO.Configuration
{
    internal sealed class Profile
    {
        ...
        [JsonProperty] public bool NeedOpenCorpse { get; set; }
        ...
        [JsonProperty] public int ItemScale { get; set; } = 4;
        [JsonProperty] public int AutoLootDelay { get; set; } = 500;
        [JsonProperty] public ushort AutoBuyAmount { get; set; } = 30;
        [JsonProperty] public ushort MinRange { get; set; } = 0;
        [JsonProperty] public ushort MaxRange { get; set; } = 12;
        ...
        [JsonProperty] public List<ushort[]> BuyList { get; set; } = null;
        ...
        [JsonProperty] public bool ShowNameInChat { get; set; } = false;
                        ...
                        try
                        {
                            ...
                            switch (type)
                            {
                                ...
                                case GUMP_TYPE.GT_COUNTERBAR:
                                    ...
                                    break;
                                case GUMP_TYPE.GT_OBJECTMENU:
                                    gump = new ObjectBarGump();
                                    break;
